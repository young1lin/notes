...
1. 《高效能人士的七个习惯》
2. 《心流》——如果你真的想成为效率极高的人，你应该看这本书。重点在达到心流，任务拆解，敏捷开发中的内容。
3. 《学会提问》（避免二元思维，值得一看）
4. 《金字塔原理》
...
34. 《我们为什么要睡觉》了解睡眠，evidence-based.
    ...
    4. 快速眼动和非快速眼动。
35. 《自控力》可快速阅读，其实我已经做到了。自控是有感染力的。只是为你缓解些许焦虑的书籍，其他的书籍也有《身份的焦虑》、《好的焦虑》、《精神焦虑症的自救》、《焦虑症与恐惧症手册》
36. 《人体简史》——你的身体已经30亿年了。
37. 《程序员修炼之道》——从小工到专家。里面也会讲一些技术知识。
38. 《极客与团队》——值得一看
39. 《Can't Hurt Me》—— 需要一定词汇量，高中以上。如果一页有 10 几个单词不会，不建议看。
40. 《真实的幸福》——《心流》作者的学生写的，积极心理学书籍，值得一看。当然不能和《心流》比肩。
41. 《午夜降临抵达前》Kindle 上有卖，看完了，Ciao。旅行文学作品，值得一看。
...
2. 《微服务架构设计模式》—— 图解架构
3. 《重构：改善既有代码的设计》（《Clean Code》在 18 年就已经看完了）如果你不会重构，那你算不上 Bob 大叔眼中的专业人士，乔布斯眼中的一流队员。
...
12. 《Spring Batch 权威指南》如果不想看官网文档，可以看这个入门 Spring Batch，例子挺多的，但是这个 Spring Batch 没有 Spring Cloud Data Flow 就像是少了条腿，不自在。如果要上  Spring Cloud Data Flow ，内网部署在客户机器上的应用就别想了，还要搭内网的 Maven 私服，很麻烦。而且如果你懂 Spring 的源码，这个其实你也可以写，很简单的框架。也可以用 Azkaban 来调度，写成 Controller 来调度就行了。但对我这个项目来说，没必要。
13. 还有本 Spring Security 的书籍，《Spring Security实战》入门罢了。
14. 《图解 HTTP》、《网络是怎样连接的》，对于不想看黑皮书《TCP/IP 详解》的人来说，这个就是甜品。甜品终究是甜品，成不了正餐。
15. The Clean Coder —— Bob 大叔又一书籍，虽比不上他的 《Clean Architecture》，也是值得一读的。如果你不精通设计模式，那些设计原则 （SOLID、KISS、DRY等等），工件（UML 图，DFD 图等），软件开发模型（当然包含敏捷开发）。
...
17. 《成为技术领导者》 温伯格技术思想三部曲之一，你不必成为所谓的被任命的领导（Manager），你也可以拥有 Leadership。好的领导，是起激励作用，不直接参加反应，是化学反应中的催化剂。
