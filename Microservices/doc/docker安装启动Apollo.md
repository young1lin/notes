...
docker run -p 8080:8080 \
    ...
    -d -v /Users/linyoung/young1lin/soft/apollo-/logs:/opt/logs --name apollo-configservice apolloconfig/apollo-configservice
...
docker run -p 8090:8090 \
    -e SPRING_DATASOURCE_URL="jdbc:mysql://${HOST_IP}:3306/ApolloConfigDB?characterEncoding=utf8" \
    -e SPRING_DATASOURCE_USERNAME=root -e SPRING_DATASOURCE_PASSWORD=123456 \
    -d -v /Users/linyoung/young1lin/soft/apollo-/logs:/opt/logs --name apollo-adminservice apolloconfig/apollo-adminservice
...
docker run -p 8070:8070 \
    ...
    -d -v /Users/linyoung/young1lin/soft/apollo-/logs:/opt/logs --name apollo-portal apolloconfig/apollo-portal
